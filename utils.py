...
def path_check(args):
    ...
    if not os.path.exists(os.path.join(args.model_save_path)):
        os.mkdir(os.path.join(args.model_save_path))
    ...
    if not os.path.exists(os.path.join(args.model_save_path, args.data_name, args.tokenizer)):
        os.mkdir(os.path.join(args.model_save_path, args.data_name, args.tokenizer))

    if not os.path.exists(os.path.join(args.model_save_path, args.data_name, args.tokenizer, args.model_type)):
        os.mkdir(os.path.join(args.model_save_path, args.data_name, args.tokenizer, args.model_type))
